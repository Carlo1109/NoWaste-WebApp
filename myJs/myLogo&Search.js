//In questo file viene creata l'applicazione "mylogosearch" tramite l'utilizzo di Vue.js per poter includere in tutte le nostre pagine l'header tramite la scrittura "<mylogosearch></mylogosearch>"
