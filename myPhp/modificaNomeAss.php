...
<html lang="it">
  ...
  <?php
      ...
      if ($pswCurrInserita != $sessionPsw) {
        $_SESSION["modificaERR"] = "La password corrente inserita non è corretta. Aggiornamento del Nome dell'associazione non riuscito. Premere 'OK' per tornare alla home.";
      }
      else {
