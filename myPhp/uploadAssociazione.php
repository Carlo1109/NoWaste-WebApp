<!--
  Questo file php è utilizzato per poter popolare la pagina ASSOCIAZIONE e visualizzare i prodotti caricati dai donatori. Interagisce con il database dei prodotti.
-->
<?php
  session_start();
