...
// Esecuzione della query per selezionare i dati dell'utente con email = 'ciao@gmail.com'
...
?>
    ...
    <?php 
      if($_SESSION["assBoolean"]){
        ...
        echo '<p>Nome Associazione: '.$userData['nomeass'].'</p>';
      }
      else{
        echo '<p>DONATORE</p>';
        if($userData['idaz']==''){
          echo '<p>nome: '.$userData['nomep'].'</p>
          <p>cognome: '.$userData['cognomep'].'</p>';
        }
        else{
          echo '<p>Id Azienda: '.$userData['idaz'].'</p>';
        }
      }
    ?>
    <p>Email: <?php echo $userData['email']; ?></p>
    <p>Password: <?php echo $userData['pswd']; ?></p>
