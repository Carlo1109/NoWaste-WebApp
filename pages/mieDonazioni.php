...
<html lang="ita">
    ...
    <hr>
    <div class="containerTable mt-3 justify-content-center">
   ...
   <hr>
   <footer class="bg-dark text-white footerDon">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
