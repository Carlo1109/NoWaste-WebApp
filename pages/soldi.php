              ...
              <div class="col-md-6">
                <div class="mb-4">
                  ...
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    ...
                    <label class="btn btn-secondary">
                      <input class="form-check-input" type="radio" id="pp" name="paymentMethod" value="paypal" onclick="showPayment();">
